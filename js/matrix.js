$(function(){
  ...
  challenge.push($("tr:nth-child(5) > th:nth-child(1)").text());
  ...
  chrome.storage.sync.get(function(storage){
    ...
    $('[name="message3"]:first').val(response[0]);
    $('[name="message4"]:first').val(response[1]);
    $('[name="message5"]:first').val(response[2]);
    $('[name="OK"]:first').click();
  });
});
